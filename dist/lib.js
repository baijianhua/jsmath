...
System.register([], function (exports_1, context_1) {
    ...
    return {
        setters: [],
        execute: function () {//https://blog.csdn.net/zgz682000/article/details/81223266 jsdoc
            //javascript 有源代码，无需运行环境，但是没有类型
            //如果浏览器原生支持 typescript多好，就不必用这个东西了。有这几个东西
            //https://stackoverflow.com/questions/14015899/embed-typescript-code-in-an-html-document
            //https://stackoverflow.com/questions/22885955/typescript-support-in-modern-browsers
            ...
            Coord = /** @class */ (function () {
                function Coord() {
                    /**@type {number} */ this.marginInPixel = 5;
                    /**@type {number} */ this.pxPerUnit = 20;
                    /**@type {number} */ this.minX = -5;
                    /**@type {number} */ this.minY = -5;
                }
                /**绘制坐标系*/
                Coord.prototype.paint = function () {
                    ...
                    var totalXUnits = (this._widthPx - 2 * this.marginInPixel) / this.pxPerUnit;
                    var totalYUnits = (this._heightPx - 2 * this.marginInPixel) / this.pxPerUnit;
                    ...
                    for (var x = this.minX; x <= totalXUnits; x++) {
                        this.drawLine(x, null);
                    }
                    for (var y = this.minY; y <= totalYUnits; y++) {
                 ...
                 * @param {number | null} y
                 */
                Coord.prototype.drawLine = function (x, y) {
                 ...
                 * @param {number} y
                 */
                Coord.prototype.drawVector = function (x, y) {
                    //将x,y坐标转化为像素的xy坐标然后绘制      
                    var pt = this.toScreenPoint(x, y);
                    ctx.lineWidth = 1;
                 ...
                 * @returns {Point}
                 */
                Coord.prototype.toScreenPoint = function (x, y) {
            ...
            Matrix = /** @class */ (function () {
                function Matrix() {
                    /**@type {number} */ this._row = 3;
                    /**@type {number} */ this._col = 3;
                }
                /**
                 *
                 * @param {number} row
                 ...
                 */
                Matrix.prototype.constuctor = function (row, col, val) {
                    this._row = row;
                    this._col = col;
                };
                /**
            ...
            Vector = /** @class */ (function () {
                function Vector() {
                    /**@type {number} */ this._count = 0;
                    /**@type {Array<number|string>} */ this._vals = 0;
                }
                Vector.prototype.constuctor = function (count) {
                    this._count = count;
                 ...
                 * @returns {Matrix}
                 */
                Vector.prototype.vectorProduct = function () {
                };
                /**
                 * @returns {Matrix}
                 */
                Vector.prototype.cartesianProduct = function () {
                };
                /**
                 * @param {number} v
                 * @returns {number}
                 */
                Vector.prototype.innerProdut = function (v) {
                    r;
                };
                /**
                 * @param {number} v
                 * @returns {number}
                 */
                Vector.prototype.matrixProduct = function (v) {
                };
                return Vector;
            }());
